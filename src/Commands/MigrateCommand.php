...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'wellmed-lite-starterpack:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the WellmedLiteStarterpack project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for WellmedLiteStarterpack project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('wellmed-lite-starterpack:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
